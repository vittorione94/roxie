...
def _td4_grad_step(
    ...
    *,
    ...
    """Executes a single TD4 gradient step, conditionally updating policy and target networks."""
...
def _td4_grad_steps(
    ...
    """Runs one learning pass of TD4 gradient steps via `jax.lax.scan`."""
...
class TD4(D4PG):
    ...
    def _compile_and_run(self, agent_rng: jax.Array, target_steps: int):
        ...
        return target_steps, _td4_grad_steps(
            self.state,
            agent_rng,
            target_steps,
            self.hp,
